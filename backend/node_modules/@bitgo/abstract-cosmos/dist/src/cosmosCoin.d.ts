...
export declare class CosmosCoin extends BaseCoin {
     ...
     */
    recover(params: RecoveryOptions, openSSLBytes: Uint8Array): Promise<CosmosLikeCoinRecoveryOutput>;
    /**
    ...
    }, openSSLBytes: Uint8Array): Promise<CosmosLikeCoinRecoveryOutput>;
