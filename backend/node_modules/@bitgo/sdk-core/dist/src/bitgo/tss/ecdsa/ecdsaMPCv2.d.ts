...
**/
export declare function getSignatureShareRoundOne(round1Message: DklsTypes.DeserializedBroadcastMessage, userGpgKey: openpgp.SerializedKeyPair<string>, partyId?: 0 | 1): Promise<SignatureShareRecord>;
export declare function getSignatureShareRoundTwo(userToBitGoMessages2: DklsTypes.DeserializedMessages, userToBitGoMessages3: DklsTypes.DeserializedMessages, userGpgKey: openpgp.SerializedKeyPair<string>, bitgoGpgKey: openpgp.Key, partyId?: 0 | 1): Promise<SignatureShareRecord>;
export declare function getSignatureShareRoundThree(userToBitGoMessages4: DklsTypes.DeserializedMessages, userGpgKey: openpgp.SerializedKeyPair<string>, bitgoGpgKey: openpgp.Key, partyId?: 0 | 1): Promise<SignatureShareRecord>;
