...
export declare const GenerateLightningWalletOptionsCodec: t.ExactC<t.TypeC<{
    label: t.StringC;
    passphrase: t.StringC;
    enterprise: t.StringC;
    passcodeEncryptionCode: t.StringC;
}>>;
export declare type GenerateLightningWalletOptions = t.TypeOf<typeof GenerateLightningWalletOptionsCodec>;
