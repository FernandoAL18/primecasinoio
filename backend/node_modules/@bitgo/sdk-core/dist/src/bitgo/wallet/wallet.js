...
class Wallet {
    ...
    flags() {
        var _a;
        return (_a = this._wallet.walletFlags) !== null && _a !== void 0 ? _a : [];
    }
    flag(name) {
        var _a;
        return (_a = this.flags().find((flag) => flag.name === name)) === null || _a === void 0 ? void 0 : _a.value;
    }
    /**
    ...
    async getNftBalances() {
        ...
        const supportedNfts = (walletData === null || walletData === void 0 ? void 0 : walletData.nfts) ? Object.values(walletData.nfts).map((balance) => balance) : [];
        const unsupportedNfts = (walletData === null || walletData === void 0 ? void 0 : walletData.unsupportedNfts)
    ...
    async shareWallet(params = {}) {
        ...
        if (needsKeychain) {
            try {
                ...
                if (keychain.encryptedPrv) {
                    ...
                    const userPrv = (0, keychain_1.decryptKeychainPrivateKey)(this.bitgo, keychain, params.walletPassphrase);
                    if (!userPrv) {
                        throw new Error('Unable to decrypt user keychain');
                    }
                    keychain.prv = userPrv;
                    const eckey = (0, bitcoin_1.makeRandomKey)();
                    const secret = (0, ecdh_1.getSharedSecret)(eckey, Buffer.from(sharing.pubkey, 'hex')).toString('hex');
        ...
        const options = {
            ...
            skipKeychain: Object.keys(sharedKeychain !== null && sharedKeychain !== void 0 ? sharedKeychain : {}).length === 0,
            keychain: Object.keys(sharedKeychain !== null && sharedKeychain !== void 0 ? sharedKeychain : {}).length === 0 ? undefined : sharedKeychain,
        };
    ...
    async prebuildAndSignTransaction(params = {}) {
        ...
        if (params.apiVersion && !supportedTxRequestVersions.includes(params.apiVersion)) {
            throw new Error(`prebuildAndSignTransaction params.apiVersion=${params.apiVersion} must be one of ${supportedTxRequestVersions}`);
        }
        // Doing a sanity check for password here to avoid doing further work if we know it's wrong
        ...
        let txPrebuildQuery;
        if (isPrebuildTransactionResult(params.prebuildTx) && ((_b = params.prebuildTx.buildParams) === null || _b === void 0 ? void 0 : _b.preview)) {
    ...
    async sendNft(sendOptions, sendNftOptions) {
        ...
        const baseAddress = (_a = this.coinSpecific()) === null || _a === void 0 ? void 0 : _a.baseAddress;
        if (!baseAddress) {
    ...
    async buildTokenEnablements(params = { enableTokens: [] }) {
        ...
        if (this._wallet.multisigType === 'tss') {
            ...
            buildParams.recipients = params.enableTokens.map((token) => {
                ...
                const address = token.address || ((_a = this._wallet.coinSpecific) === null || _a === void 0 ? void 0 : _a.baseAddress) || ((_b = this._wallet.coinSpecific) === null || _b === void 0 ? void 0 : _b.rootAddress);
                if (!address) {
    ...
    async signMessageTss(params = {}) {
        ...
        try {
            ...
            const signedMessageRequest = await this.tssUtils.signTxRequestForMessage({
                ...
                messageRaw: params.message.messageRaw,
                messageEncoded: params.message.messageEncoded,
                bufferToSign: Buffer.from((_a = params.message.messageEncoded) !== null && _a !== void 0 ? _a : ''),
            });
            ...
            return {
                ...
                messageRaw: (_b = params.message) === null || _b === void 0 ? void 0 : _b.messageRaw,
                messageEncoded: (_c = params.message) === null || _c === void 0 ? void 0 : _c.messageEncoded,
    ...
    async sendManyTss(params = {}) {
        ...
        if (onlySupportsTxRequestFull || apiVersion === 'full') {
            ...
            return {
                transfer,
                txRequest: latestTxRequest,
                txid: (_e = (_d = ((_c = latestTxRequest.transactions) !== null && _c !== void 0 ? _c : [])[0]) === null || _d === void 0 ? void 0 : _d.signedTx) === null || _e === void 0 ? void 0 : _e.id,
                tx: (_h = (_g = ((_f = latestTxRequest.transactions) !== null && _f !== void 0 ? _f : [])[0]) === null || _g === void 0 ? void 0 : _g.signedTx) === null || _h === void 0 ? void 0 : _h.tx,
                status: transfer.state,
            };
        }
        const reqId = params.reqId || undefined;
        return (_j = this.tssUtils) === null || _j === void 0 ? void 0 : _j.sendTxRequest(signedTransaction.txRequestId, reqId);
    }
    /**
    ...
    sendTransaction(params, reqId) {
        ...
        return (0, postWithCodec_1.postWithCodec)(this.bitgo, this.baseCoin.url('/wallet/' + this.id() + '/tx/send'), public_types_1.TxSendBody, whitelistedParams).result();
    }
...
//# sourceMappingURL=data:application/json;base64,