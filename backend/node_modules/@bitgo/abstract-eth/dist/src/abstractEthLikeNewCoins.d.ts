...
export declare type RecoverOptionsWithBytes = {
    isTss: true;
    openSSLBytes: Uint8Array;
};
export declare type NonTSSRecoverOptions = {
    isTss?: false | undefined;
};
export declare type TSSRecoverOptions = RecoverOptionsWithBytes | NonTSSRecoverOptions;
